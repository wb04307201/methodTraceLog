...
public class SimpleeLogServiceImpl implements ILogService {
    ...
    public void log(String traceid, String pspanid, String spanid, String classname, String methodSignature, Object context, LogActionEnum logActionEnum) {
        if (logActionEnum == LogActionEnum.AFTER_THROW)
            log.error("traceid: {}, pspanid: {}, spanid: {}, classname: {}, methodSignature: {}, context: {}, logActionEnum: {}, time: {}", traceid, pspanid, spanid, classname, methodSignature, transContext(context), logActionEnum, System.currentTimeMillis());
        else
            log.info("traceid: {}, pspanid: {}, spanid: {}, classname: {}, methodSignature: {}, context: {}, logActionEnum: {}, time: {}", traceid, pspanid, spanid, classname, methodSignature, transContext(context), logActionEnum, System.currentTimeMillis());
    }
